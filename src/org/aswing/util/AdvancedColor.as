...
public class AdvancedColor extends ASColor
{
	private var red:int;
	...
	public function AdvancedColor (color:int, alpha:Number){
		setRGB(color);
		setAlpha(alpha);
	}
	
	private function setRGB(rgb:int=0):void{
		this.rgb = rgb;
     ...
     */
	override public function getRed():int{
		return red;
	}
     ...
     */	
	override public function getGreen():int{
		return green;
	}
     ...
     */	
	override public function getBlue():int{
		return blue;
	}
	 ...
	 * @param a (optional)the alpha[0, 1,] default is 1
	 ...
	 */
	public static function getRGBColor(r:int, g:int, b:int, a:Number):AdvancedColor{
