...
public class BasicLookAndFeel extends LookAndFeel{
	...
	protected function initComponentDefaults(table:UIDefaults):void{
		...
		var comDefaults:Array = [
			...
			"Button.textFilters", new ArrayUIResource([new DropShadowFilter(1, 45, 0, 0.3, 1, 1, 1, 1)])
		];
		...
		comDefaults = [
			...
			"ToggleButton.textFilters", new ArrayUIResource([new DropShadowFilter(1, 45, 0, 0.3, 1, 1, 1, 1)])
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"RadioButton.textFilters", new ArrayUIResource()
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"CheckBox.textFilters", new ArrayUIResource()
		];
		table.putDefaults(comDefaults);
