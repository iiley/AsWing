...
{
	public function ClosableTabbedPane()
	{
		super();
		doTabbedPaneTest();
	}
	
	private var tabbedPane:JClosableTabbedPane;
	...
	public function doTabbedPaneTest():void {
		...
		tabbedPane.addEventListener(TabCloseEvent.TAB_CLOSING, __tabClosing);
		...
		tabbedPane.setCloseEnabledAt(1, false);
	...
	private function __tabClosing(e:TabCloseEvent):void{
		tabbedPane.removeTabAt(e.getIndex());
	}
